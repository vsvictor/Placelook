...
abstract interface class ArcGISAuthenticationChallengeHandler {
  /// Handles the given authentication challenge.
  ///
  /// Use [ArcGISAuthenticationChallenge.continueWithCredential], [ArcGISAuthenticationChallenge.continueAndFail], or
  /// [ArcGISAuthenticationChallenge.cancel] to handle the challenge.
